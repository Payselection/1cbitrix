...
$MESS["SALE_PAYSELECTION_ID"] = "Идентификатор(SITE-ID)";
...
$MESS["SALE_PAYSELECTION_RECEIPT_VALUE_1"] = "Упрощённая, доход";
$MESS["SALE_PAYSELECTION_RECEIPT_VALUE_2"] = "Упрощённая, доход минус расход";
...
$MESS["SALE_PAYSELECTION_NDS_vat22"] = "НДС чека по ставке 22%";
...
$MESS["SALE_PAYSELECTION_NDS_vat122"]  = "НДС чека по расчетной ставке 22/122";
